...
def main():
    ...
    parser.add_argument(
        "-o", "--output_path", default="./outputs", type=str, help="output path"
    )
    parser.add_argument(
        "--model_path",
        default="./work_dir/swinunetr_3class",
    ...
    with torch.no_grad():
        for img_name in img_names:
            ...
            test_tensor = (
                torch.from_numpy(np.expand_dims(test_npy01, 0))
                .permute(0, 3, 1, 2)
